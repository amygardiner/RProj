...
ggplot()+xlab("x")+geom_line(aes(x=range,y=plot_1,color="red"))+geom_line(aes(x=range,y=plot_2,color="green"))+geom_line(aes(x=range,y=plot_3,color="blue"))+ylab("Density")
```
