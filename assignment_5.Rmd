...
for(i in range){
  ...
  vector<-c(vector,i)
  # can i push back into a vector in R?
  print(sample_avg)
  #sample_averages_data<-data.frame(i,sample_avg)
  
}

vector

ggplot()+xlab("Value of Beta")+geom_line(aes(x=i,y=sample_avg))+ylab("Sample Average")
