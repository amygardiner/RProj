...
cplot_2<-pnorm(range,mean=1,sd=2,lower.tail=TRUE,log.p=FALSE)
cplot_3<-pnorm(range,mean=1,sd=3,lower.tail=TRUE,log.p=FALSE)
...
qplot_2<-qnorm(cplot_1,mean=1,sd=2,lower.tail=TRUE,log.p=FALSE)
qplot_3<-qnorm(cplot_1,mean=1,sd=3,lower.tail=TRUE,log.p=FALSE)
