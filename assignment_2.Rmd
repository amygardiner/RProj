...
```{r,echo=FALSE}
hawksWithBMI<-select(Hawks,Species,Weight,Wing)
hawksWithBMI<-mutate(hawksWithBMI,bird_BMI=1000*Weight/(Wing)**2)
hawksWithBMI<-select(hawksWithBMI,Species,bird_BMI)
head(arrange(hawksWithBMI,desc(bird_BMI)))
```
